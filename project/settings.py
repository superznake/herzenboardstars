...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # <- добавляем
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'assets'),  # Раскомментируйте если создадите папку
]
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'awards.pipeline.save_jury_status',
